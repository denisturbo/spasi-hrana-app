...
from django.forms.widgets import TextInput, RadioSelect, NumberInput
...
class PromocodeCreation(ModelForm):
    ...
    class Meta:
        model = Promocode
        exclude = ['connection']
        widgets = {'listing': RadioSelect(attrs={"class": "w-4 h-4 text-orange-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-orange-500"}),
