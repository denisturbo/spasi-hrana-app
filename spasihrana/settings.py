"""
Django settings for spasihrana project.
...
CSRF_TRUSTED_ORIGINS = env.list("CSRF_TRUSTED_ORIGINS", subcast=str, default=["127.0.0.1", "localhost"])
...
WSGI_APPLICATION = 'spasihrana.wsgi.application'
